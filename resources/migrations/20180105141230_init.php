...
***REMOVED***
    ...
    ***REMOVED***
        ...
        $table->addColumn('name_de', 'string', ['null' => false, 'limit' => 45, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'permission_id'])->update();
        ...
        $table->save();
        if($this->table('app_position')->hasIndex('fk_position_permission1_idx')) ***REMOVED***
            $this->table("app_position")->removeIndexByName('fk_position_permission1_idx');
    ***REMOVED***
        $this->table("app_position")->addIndex(['permission_id'], ['name' => "fk_position_permission1_idx", 'unique' => false])->save();
