...
class AddedEventArticles extends AbstractMigration
***REMOVED***
    ...
    ***REMOVED***
        ...
        $this->table("app_language")->changeColumn('name', 'string', ['null' => false, 'limit' => 4, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'id'])->update();
        $this->table("app_language")->changeColumn('abbreviation', 'string', ['null' => false, 'limit' => 2, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'name'])->update();
        ...
        $this->table("app_user")->changeColumn('permission_id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'language_id'])->update();
        ...
        $this->table("app_user")->changeColumn('js_certificate', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'signup_completed'])->update();
        ...
        $this->table("article")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'barcode'])->update();
        $this->table("article")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("article")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("article")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("article")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("article")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("article")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("article_description")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("article_description")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("article_description")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("article_description")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("article_description")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("article_description")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        ...
        $this->table("article_quality")->changeColumn('name', 'string', ['null' => false, 'limit' => 45, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'level'])->update();
        ...
        $this->table("article_title")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("article_title")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("article_title")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("article_title")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("article_title")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("article_title")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("article_title")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        $this->table("city")->changeColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'identity' => 'enable'])->update();
        $this->table("city")->changeColumn('country', 'string', ['null' => false, 'limit' => 2, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'id'])->update();
        $this->table("city")->changeColumn('state', 'string', ['null' => false, 'limit' => 10, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'country'])->update();
        $this->table("city")->changeColumn('number', 'string', ['null' => false, 'limit' => 10, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'state'])->update();
        $this->table("city")->changeColumn('number2', 'string', ['null' => true, 'limit' => 10, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'number'])->update();
        $this->table("city")->changeColumn('title_de', 'string', ['null' => true, 'limit' => 255, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'number2'])->update();
        $this->table("city")->changeColumn('title_fr', 'string', ['null' => true, 'limit' => 255, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'title_de'])->update();
        $this->table("city")->changeColumn('title_it', 'string', ['null' => true, 'limit' => 255, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'title_fr'])->update();
        $this->table("city")->changeColumn('title_en', 'string', ['null' => true, 'limit' => 255, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'title_it'])->update();
        ...
        $this->table("city")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        ...
        $this->table("department_type")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("department_type")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("department_type")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("department_type")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("department_type")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("department_type")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("department_type")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("educational_course")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'minimum_age'])->update();
        $this->table("educational_course")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("educational_course")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("educational_course")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("educational_course")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("educational_course")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("educational_course")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("educational_course_description")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("educational_course_description")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("educational_course_description")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("educational_course_description")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("educational_course_description")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("educational_course_description")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("educational_course_description")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("educational_course_title")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("educational_course_title")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("educational_course_title")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("educational_course_title")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("educational_course_title")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("educational_course_title")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("educational_course_title")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("event")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'publicize_at'])->update();
        $this->table("event")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("event")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("event")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("event")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("event")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("event")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
    ...
    ***REMOVED***
        ...
        $this->table("event_description")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("event_description")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("event_description")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("event_description")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("event_description")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("event_description")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("event_description")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("event_title")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name_it'])->update();
        $this->table("event_title")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("event_title")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("event_title")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("event_title")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("event_title")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("event_title")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        $this->table("gender")->changeColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'identity' => 'enable'])->update();
        $this->table("gender")->changeColumn('name', 'string', ['null' => false, 'limit' => 45, 'collation' => "utf8_general_ci", 'encoding' => "utf8", 'after' => 'id'])->update();
        ...
        $this->table("image")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'type'])->update();
        ...
        $this->table("image")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        ...
        $this->table("image")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("image")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("image")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("sl_chest")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name'])->update();
        $this->table("sl_chest")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("sl_chest")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("sl_chest")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("sl_chest")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("sl_chest")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("sl_chest")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("sl_corridor")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name'])->update();
        $this->table("sl_corridor")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("sl_corridor")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("sl_corridor")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("sl_corridor")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("sl_corridor")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("sl_corridor")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("sl_location")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name'])->update();
        $this->table("sl_location")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("sl_location")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("sl_location")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("sl_location")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("sl_location")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("sl_location")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("sl_room")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name'])->update();
        $this->table("sl_room")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("sl_room")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("sl_room")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("sl_room")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("sl_room")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("sl_room")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("sl_shelf")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name'])->update();
        $this->table("sl_shelf")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("sl_shelf")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("sl_shelf")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("sl_shelf")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("sl_shelf")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("sl_shelf")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
        ...
        $this->table("sl_tray")->changeColumn('created', 'datetime', ['null' => true, 'after' => 'name'])->update();
        $this->table("sl_tray")->changeColumn('created_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'created'])->update();
        $this->table("sl_tray")->changeColumn('modified', 'datetime', ['null' => true, 'after' => 'created_by'])->update();
        $this->table("sl_tray")->changeColumn('modified_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'modified'])->update();
        $this->table("sl_tray")->changeColumn('deleted', 'integer', ['null' => false, 'default' => '0', 'limit' => MysqlAdapter::INT_TINY, 'precision' => 3, 'after' => 'modified_by'])->update();
        $this->table("sl_tray")->changeColumn('deleted_at', 'datetime', ['null' => true, 'after' => 'deleted'])->update();
        $this->table("sl_tray")->changeColumn('deleted_by', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'deleted_at'])->update();
