...
## On Error***REMOVED***#error***REMOVED***
Following information must be provided on every error

- code
- INFOARRAY info (optional)
	- message
	- errors

## On Success***REMOVED***#success***REMOVED***
Following information must be provided on every success

- code
- message

## Default Requests
### Default API Authentication***REMOVED***#default-api-auth***REMOVED***

## Default Responses
### Userarray***REMOVED***#userarray***REMOVED***
user => [
  id
  department_id
  position_id
...
user => [
  ...
  username
  password
  lang (de_CH, en_GB, fr_CH, it_CH)
]
**Response**
[Success](#success) or [Error](#error)

#### Single user
**GET** /v2/users/***REMOVED***user_id***REMOVED***
**Request**
[default API auth](#default-api-auth)
**Response**
[userarray](#userarray) or [Error](#error)

#### Update specific user
**PUT** /v2/users/***REMOVED***user_id***REMOVED***
**Request**
[default API auth](#default-api-auth)
__department_id__
__position_id__
...
## Delete user
**DELETE** /v2/users/***REMOVED***user_id***REMOVED***
**Request**
[default API auth](#default-api-auth)
**Response**
[Success](#success) or [Error](#error)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## Basic informations
GET					'/v2/departmentgroups'													All department groups (AGSOLUZG)
+ id
+ name_de
+ name_en
+ name_fr
...
GET					'/v2/departments' 														All departments
- token
? limit
? offset
...
POST				'/v2/departments' 														All departments
- token
- name
- city_id
- department_group_id

GET					'/v2/departments/***REMOVED***department_id***REMOVED***'										Single department
+ DEPARTMENT
	+ name
	+ city
		+ city_id
...
PUT					'/v2/departments/***REMOVED***department_id***REMOVED***'										Single department
- token
- name
- department_group_id

DELETE				'/v2/departments/***REMOVED***department_id***REMOVED***'										Single department
- token
- department_id

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

GET					'/v2/departments/***REMOVED***department_id***REMOVED***/articles'								All Articles by department
- token
? limit
? offset
? lang
...
POST				'/v2/departments/***REMOVED***department_id***REMOVED***/articles'								All Articles by department
- token
- lang
- ARTICLE
  - name
...
GET					'/v2/departments/***REMOVED***department_id***REMOVED***/articles/***REMOVED***article_id***REMOVED***'					Article by department
- token
? lang
...
PUT					'/v2/departments/***REMOVED***department_id***REMOVED***/articles/***REMOVED***article_id***REMOVED***'					Article by department
- token
- lang
- article
  - name
...
DELETE				'/v2/departments/***REMOVED***department_id***REMOVED***/articles/***REMOVED***article_id***REMOVED***'					Article by department
- token
- article_id
